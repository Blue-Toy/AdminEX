...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <!--sidebar nav start-->
            <ul class="nav nav-pills nav-stacked custom-nav">
                <li class="menu-list"><a href="index.jsp"><i class="fa fa-home"></i> <span>Dashboard</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="index_alt.jsp"> Dashboard 1</a></li>
                ...
                <li class="menu-list nav-active"><a href="#"><i class="fa fa-th-list"></i> <span>Data Tables</span></a>
                    <ul class="sub-menu-list">
                        ...
                        <li class="active"><a href="showlist.do"> Edit Table</a></li>
                    </ul>
                </li>
                        ...
                        <div class="panel-body">
                            <div class="adv-table editable-table ">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <tbody>
                                    <%
                                        List<EMPList> emplist = (List<EMPList>) request.getAttribute("emplist");

                                        for(EMPList emp1:emplist){
                                    ...
                                    %>
                                                <tr class="">
                                                    ...
                                                    <td><%=emp1.getEname()%></td>
                                                    <td><%=emp1.getJob()%></td>
                                                    <td class="center"><%=emp1.getSal()%></td>
                                                    <td><a class="edit" id="first1" href="">Edit</a></td>
