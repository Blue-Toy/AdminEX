            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list nav-active"><a href="#"><i class="fa fa-th-list"></i> <span>Data Tables</span></a>
                    <ul class="sub-menu-list">
                        ...
                        <li class="active"><a href="dynamic_table.jsp"> Advanced Table</a></li>
                        <li><a href="responsive_table.html"> Responsive Table</a></li>
                        <li><a href="showlist.do"> Edit Table</a></li>
                    </ul>
                </li>
                            ...
                            <div class="adv-table">
                                <table  class="display table table-bordered table-striped" id="dynamic-table">
                                    ...
                                    <tr>
                                        ...
                                        <th>ENAME</th>
                                        <th>JOB</th>
                                        <th class="hidden-phone">SAL</th>
                                        <th class="hidden-phone">MANAGE</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th>JOB</th>
                                        <th class="hidden-phone">SAL</th>
                                        <th class="hidden-phone">MAMAGE</th>
                                    </tr>
                                    </tfoot>
                                </table>
                            </div>
